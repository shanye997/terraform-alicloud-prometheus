...
- [`examples/complete`](examples/complete): create a Prometheus instance and its basic alerting resources.
- [`examples/with_collection`](examples/with_collection): create a Prometheus instance outside the module and an ARMS environment custom collection job through the module.
- [`examples/with_alerting`](examples/with_alerting): create a Prometheus instance outside the module and configure contacts and dispatching through the module.
